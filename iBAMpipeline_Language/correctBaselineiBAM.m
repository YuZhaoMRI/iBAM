function [Yc, baseLineInfo] = correctBaselineiBAM(Y, opts)
%correctBaselineiBAM Performs robust baseline correction and noise normalization on fluorescence traces.
%
%   [Yc, normalization_info] = correctBaselineiBAM(Y, opts) applies a robust
